...
# sequence pkl file path from Rafa
filepath_sequence_pkl_wo_ornament = './sequences/pitchWithOut.pkl'
filepath_sequence_pkl_w_ornament = './sequences/pitchWith.pkl'

# pattern candidates json
filepath_pattern_candidates_w_ornament_json = './sequences/patternsCandidates_w_ornament.json'
filepath_pattern_candidates_replication_w_ornament_json = './sequences/patternsCandidatesReplication_w_ornament.json'
filepath_pattern_candidates_replication_midinote_w_ornament_json = \
    './sequences/patternsCandidatesReplicationMidinote_w_ornament.json'

filepath_pattern_candidates_wo_ornament_json = './sequences/patternsCandidates_wo_ornament.json'
filepath_pattern_candidates_replication_wo_ornament_json = './sequences/patternsCandidatesReplication_wo_ornament.json'
